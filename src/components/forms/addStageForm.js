...
import { addStage } from "../../redux/actions/stages/stagesActions";
...
AddStageName = reduxForm({
  form: "AddStage",
  onSubmit(values, dispatch) {
    dispatch(addStage(values));
  },
